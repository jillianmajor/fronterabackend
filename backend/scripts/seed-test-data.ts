...
async function main(): Promise<void> {
  ...
  try {
    ...
    console.log('');
    console.log('Master PRN Availability Calendar:');
    ...
    console.log('');
    console.log('Master PTO Calendar:');
    console.log('  GET http://localhost:3000/admin/master-pto/filter-options?company=Frontera');
